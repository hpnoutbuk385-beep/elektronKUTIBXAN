...
const BOOK_CONTENT = {
  "101": { title: "O'tkan kunlar", author: "Abdulla Qodiriy", image: "https://kitobxon.com/img_u/b/887.jpg", file: "https://n.ziyouz.com/books/o_zbek_nasri/Abdulla%20Qodiriy%20-%20O'tgan%20kunlar%20(roman).pdf", pages: ["1264-inchi hijriya, dalv oyining o'ninchisi...", "Kumushbibi o'z xonasida o'tirib...", "Otabek va Kumushning uchrashuvi..."] },
  "102": { title: "Mehrobdan chayon", author: "Abdulla Qodiriy", image: "https://kitobxon.com/img_u/b/1500.jpg", file: "https://n.ziyouz.com/books/o_zbek_nasri/Abdulla%20Qodiriy%20-%20Mehrobdan%20chayon%20(roman).pdf", pages: ["Xudoyorxon saroyidagi hiylalar...", "Ra'noning maktubi...", "Mehrob ichidagi sirlar..."] },
  "103": { title: "Kecha va kunduz", author: "Cho'lpon", image: "https://kitobxon.com/img_u/b/2034.jpg", file: "https://n.ziyouz.com/books/o_zbek_nasri/Cho'lpon%20-%20Kecha%20va%20kunduz.pdf", pages: ["Zebi o'zining yoshligi...", "Akbarali mingboshi saroyi...", "Ozodlik va zulmat kurashi..."] },
  "104": { title: "Yulduzli tunlar", author: "Pirimqul Qodirov", image: "https://kitobxon.com/img_u/b/2012.jpg", file: "https://n.ziyouz.com/books/o_zbek_nasri/Pirimqul%20Qodirov%20-%20Yulduzli%20tunlar%20(roman).pdf", pages: ["Bobur Mirzo taxtga o'tirishi...", "Yulduzli tunlarda Boburnoma...", "Vatan sog'inchi..."] },
  "107": { title: "Atom odatlar", author: "James Clear", image: "https://kitobxon.com/img_u/b/6146.jpg", file: "https://docs.google.com/viewer?url=https://www.pdfdrive.com/download.pdf&embedded=true", pages: ["Kichik o'zgarishlar - katta natijalar...", "Odatlarni shakllantirish...", "O'zlikni o'zgartirish..."] },
  "default": { title: "Kitob", author: "Muallif", image: "https://kitobxon.com/img_u/b/887.jpg", file: null, pages: ["Sahifa 1", "Sahifa 2", "Sahifa 3"] }
};
...
export default function PreviewPage() {
  ...
  useEffect(() => {
    // FOYDALANUVCHI KIRGANMI YOKI YO'QMI TEKSHIRAMIZ
  ...
  return (
    <div className="preview-page animate-fade">
      ...
      <style jsx>{`
        ...
        .side-cover-img { width: 100%; border-radius: 15px; margin-bottom: 25px; }
        .side-desc-text { color: rgba(255,255,255,0.7); font-size: 1rem; line-height: 1.7; margin-bottom: 25px; }
        .borrow-btn-large { background: linear-gradient(135deg, #6366f1 0%, #818cf8 100%); width: 100%; padding: 16px; border-radius: 15px; font-weight: 700; }
